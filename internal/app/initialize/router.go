...
func Routers() *gin.Engine {
	...
	Router.StaticFS(global.CONFIG.Local.IPFS, http.Dir(global.CONFIG.Local.IPFS))
	...
	DetaskGroup.Use(middleware.Chain()).Use(middleware.Lang())
	{
		router.InitBaseRouter(DetaskGroup)
